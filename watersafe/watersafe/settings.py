# Django settings for watersafe project.
...
SECRET_KEY = 'opo=cfpq7zb&amp;x*1sjw&amp;yh(6525^c$ib!!@%h7=1qi$z@t!s(5s'
...
ROOT_URLCONF = 'watersafe.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'watersafe.wsgi.application'

TEMPLATE_DIRS = (
    "/home/javon/dev/opensource/watersafe/watersafe/templates", #CHANGE_ME
